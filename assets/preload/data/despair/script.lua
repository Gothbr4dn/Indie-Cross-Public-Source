function onCreate()
	if dadName == 'Bendy-Nightmare' then
		makeAnimatedLuaSprite('animatedicon', 'UI_assets', getProperty('iconP2.x'), getProperty('iconP2.y'))
		addAnimationByPrefix('animatedicon', 'winning', 'nightmare bendy win0', 24, true)
		addAnimationByPrefix('animatedicon', 'normal', 'nightmare bendy normal0', 24, true)
